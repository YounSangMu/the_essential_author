...
#4-2. 5번 문항 : 성향 
options_tendency_2 = {
    "관계가 소원해진 원인을 냉정히 분석하고 대화를 시도한다.": "GO",
    "냉철한 자기반성 후에 마음을 솔직하게 표현한다.": "KSY",
    "사람의 관계는 변화하는 법이라며 자연스럽게 받아들인다.": "AC",
    "쿨한 척 돌아서지만, 오랫동안 친구를 기다린다." : "SF",
    "친구와의 추억을 글이나 시로 표현한다.": "DO"
}

tendency_2 = st.radio(
'Q2-2. 오랜 친구와의 관계가 멀어졌습니다. 당신은 어떻게 할까요?',list(options_tendency_2.keys())
)
...
#4-3. 6번 문항 : 성향 
options_tendency_3 = {
    "사람들의 상처와 고통이 사라진 조용하고 평화로운 세상을 만든다.": "HG",
...
tendency_3 = st.radio(
'Q2-3. 세상을 마음대로 바꿀 수 있다면, 무엇을 하시겠습니까?', list(options_tendency_3.keys())
)
...
#4-4. 7번 문항 : 성향 
options_tendency_4 = {
    "문제의 원인을 분석하고 해결책을 제시한다.": "GO",
    "따뜻한 말보다 옆에서 조용히 함께 있어준다.": "HG",
    "그 고통조차 삶의 일부라며 받아들일 수 있도록 도와준다.": "AC",
    "재미있는 이야기나 활동으로 기분을 전환시킨다.": "SF",
    "자신의 상처를 이야기하며 혼자가 아님을 말한다.": "DO"
}

tendency_4= st.radio(
'Q2-4. 사랑하는 사람이 힘들어할 때, 당신은 어떻게 위로하나요?',list(options_tendency_4.keys())
)
...
options_simulation_2 = {
    ...
    "고급스러운 와인과 로맨틱한 저녁 식사" : "SF",
    "일상에서 느낄 수 있는 따뜻한 선물" : "KYS"
}
...
options_simulation_3 = {
    "문제의 원인을 논리적으로 분석하고 해결책을 제시한다." : 'GO', 
